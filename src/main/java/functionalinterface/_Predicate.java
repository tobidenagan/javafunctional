...
public class _Predicate {
    public static void main(String[] args) {
        ...
        System.out.println(
                "Is phone number valid and contains number 3 = " +
                isPhoneNumberValidPredicate.or(containsNumber3).test("09000000003"));

        System.out.println(
                "Contains A = " + containsA.test("aAb", "ab"));
    }

    static BiPredicate<String, String> containsA = (containsA, containsB) ->
            containsA.contains("A") || containsB.contains("A");
